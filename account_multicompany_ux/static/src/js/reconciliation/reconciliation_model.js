        ...
        _changePartner: function (handle, partner_id) {
            ...
            return this._rpc({
                    ...
                    if (result.length > 0) {
                        ...
                        self.lines[handle].st_line.open_balance_account_id = line.balance.amount < 0 ? result[0]['property_account_payable_id'][0] : result[0][
                            'property_account_receivable_id'][0];
                    }
                });
        },
    });
