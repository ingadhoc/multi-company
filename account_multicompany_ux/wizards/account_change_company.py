...
class AccountChangeCompany(models.TransientModel):
    ...
    def change_company(self):
        self.ensure_one()
<<<<<<< 22428eba70963297858273056af8d34b1b897e2d
||||||| 2e71cf1faec72c901c799a0608cdeec084521476
...
=======
        ...
        # EMPEZAMOS CON CAMBIOS
        # COMPANY, JOURNAL, DOC TYPE and PAYMENT TERM
>>>>>>> 9624e27fd6e6179f135479820d74a0e122a1b4f6
...
=======
    ...
    def _get_change_company_line_taxes(self, lines, taxes, fiscal_pos=None):
        ...
        if fiscal_pos:
            ...
            if new_fps:
                self.move_id.fiscal_position_id = new_fps or False
